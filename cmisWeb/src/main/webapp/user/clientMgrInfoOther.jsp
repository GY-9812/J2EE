	...
	<div class="formbody">
		<div id="usual1" class="usual">
			<div class="itab">
    			...
    			<input type="hidden" name="mgrId" id="mgrId" value="${mgrId}">
				<ul id="selectPages"> 
			    ...
			    <table class="tablelist">
			        ...
			        <tbody>
			         <c:forEach items="${resultList}" var="result">
			        		<tr>
					        <td><input name="ids"  type="checkbox" value="${result.cmKey}"  /></td>
			...
			<div id="tab7" class="tabson">
			    ...
			    <table class="tablelist">
			        ...
			        <c:forEach items="${workList}" var="work">
				        <tr>
					        <td><input name="workId" type="checkbox" value="${work.cmKey }" /></td>
					        <td>${work.mgrName }</td>
			...
			<script language="javascript">
				function openWindow(scanLog) {
					...
					if (scanLog == 1) {
						...
						var objs=document.getElementsByName("workId");//获取复选框的工作经历key
						var selectObjs=[];
			...
			<div id="light1" class="firstScan_main">
				<form action="mgrResultAdd" method="post">
					...
					<div class="formbody">
						...
						<ul class="forminfo">
						    ...
						    <li><label>工作年度</label><input name="cmWorkYear" id="officeDate" type="text" class="dfinput" value=""/> </li>
						    <li><label>工作业绩</label><input name="cmWorkResult" type="text" class="dfinput" value=""/> </li>
				...
				<form action="" method="post">
					<div class="formbody">
						...
						<ul class="forminfo">
							...
							<li><label>奖惩分类</label><input name="" type="text"
								class="dfinput" value="" /></li>
							<li><label>奖惩内容</label><input name="" type="text"
								class="dfinput" value="" /></li>
							<li><label>生效日期</label><input name="" type="text"
								class="dfinput" value="" /></li>
							<li><label>审批单位</label><input name="" type="text"
								class="dfinput" value="" /></li>
							<li><label>审批人</label><input name="" type="text"
								class="dfinput" value="" /></li>
							<li><label>撤销日期</label><input name="" type="text"
								class="dfinput" value="" /></li>
							<li><label>撤销原因</label><input name="" type="text"
								class="dfinput" value="" /></li>
							<li><label>备注</label><input name="" type="text"
								class="dfinput" value="" /></li>
							<li><label>附件上传</label><input name="" type="file"
								class="dfselect1" /></li>
							<li>&nbsp;&nbsp;<input name="" type="submit" class="btn"
								value="添加" />&nbsp;&nbsp;&nbsp;&nbsp;<input name="" type="reset"
								class="btn" value="关闭" onclick="closeWindow('light5')" /></li>
						</ul>
					</div>
				</form>
			</div>
			...
			<div id="light14" class="firstScan_main">
			    ...
			    <input type="hidden" name="cmKey" id="workCmKey"  value="">
			    <input type="hidden" name="modifier" value="${user.userId }">
			    <input type="hidden" name="cmAttach" id="workHistAttach" value="">
				<input type="hidden" name="workKey" id="workHidden" class="dfinput" value=""/> 
					<div class="formbody">
						<div class="formtitle">
							<span>修改工作经历</span>
						</div>
						<ul class="forminfo">
						    <li><label>客户经理编号</label><input name="mgrId" id="workCmId" type="text" class="dfinput" value="" readonly/> </li>
						    <li><label>任职日期</label><input name="officeDate" id="workofficeDate" type="text" class="dfinput" value=""/> </li>
						    <li><label>职务</label> 
						    	<div class="vocation">
						    ...
						    <li><label>单位</label><input name="cmUnit" id="workUnit" type="text" class="dfinput" value=""/> </li>
						    <li><label>工作经历</label><input name="cmWork" id="workWork" type="text" class="dfinput" value=""/> </li>
						    <li><label>附件上传</label><input name="upload" id="workAttach" type="file" class="dfselect1"/></li>
